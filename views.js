...
// ///////////////
    ...
    wiz.views.NavForAddress = Backbone.View.extend({
      ...
      getNextScreen: function () {
        var bid = 0;
        var nid;
        if (!(_.isUndefined(this.model.get('buttons')[bid]['Destination Screen']))) {
...
// //////////////////////
    ...
    wiz.views.ResultsView = Backbone.View.extend({
      ...
      render: function () {
        ...
        results = _.sortBy(unsorted_results, function (res) {
          if (!(_.isUndefined(res['Button Result Order']))) {
